...
import swervelibnew.SwerveModule;
import swervelibnew.math.SwerveMath;
import swervelibnew.parser.json.ControllerPropertiesJson;
import swervelibnew.parser.json.ModuleJson;
import swervelibnew.parser.json.PIDFPropertiesJson;
import swervelibnew.parser.json.PhysicalPropertiesJson;
import swervelibnew.parser.json.SwerveDriveJson;
...
public class SwerveParser
{
   ...
   *                 {@link swervelibnew.SwerveController} and drive feedforward in
   ...
   *                                   acceleration used in {@link swervelibnew.SwerveController} and drive feedforward in
   *                                   {@link SwerveMath#createDriveFeedforward(double, double, double)}.
   ...
   *                    {@link swervelibnew.SwerveController} of the robot
