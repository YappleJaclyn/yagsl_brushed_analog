...
import swervelibnew.parser.SwerveModuleConfiguration;
import swervelibnew.parser.SwerveModulePhysicalCharacteristics;
import swervelibnew.parser.json.modules.BoolMotorJson;
import swervelibnew.parser.json.modules.ConversionFactorsJson;
import swervelibnew.parser.json.modules.LocationJson;

/**
 * {@link swervelibnew.SwerveModule} JSON parsed class. Used to access the JSON data.
 */
public class ModuleJson
{
      ...
      String name)
  {
    ...
    if(absEncoder instanceof SparkMaxAnalogEncoderSwerve)
    {
      angleMotor.setAbsoluteEncoder(absEncoder);
    }
