...
import static swervelibnew.telemetry.SwerveDriveTelemetry.canIdWarning;
import static swervelibnew.telemetry.SwerveDriveTelemetry.i2cLockupWarning;
import static swervelibnew.telemetry.SwerveDriveTelemetry.serialCommsIssueWarning;

import com.ctre.phoenix.motorcontrol.FeedbackDevice;
import com.studica.frc.AHRS.NavXComType;
import edu.wpi.first.math.system.plant.DCMotor;
import edu.wpi.first.wpilibj.DriverStation;
import swervelibnew.encoders.AnalogAbsoluteEncoderSwerve;
import swervelibnew.encoders.CANCoderSwerve;
import swervelibnew.encoders.CanAndMagSwerve;
import swervelibnew.encoders.DIODutyCycleEncoderSwerve;
import swervelibnew.encoders.SparkFlexEncoderSwerve;
import swervelibnew.encoders.SparkMaxAnalogEncoderSwerve;
import swervelibnew.encoders.SparkMaxEncoderSwerve;
import swervelibnew.encoders.SwerveAbsoluteEncoder;
import swervelibnew.encoders.TalonSRXEncoderSwerve;
import swervelibnew.encoders.ThriftyNovaEncoderSwerve;
import swervelibnew.imu.ADIS16448Swerve;
import swervelibnew.imu.ADIS16470Swerve;
import swervelibnew.imu.ADXRS450Swerve;
import swervelibnew.imu.AnalogGyroSwerve;
import swervelibnew.imu.CanandgyroSwerve;
import swervelibnew.imu.NavXSwerve;
import swervelibnew.imu.Pigeon2Swerve;
import swervelibnew.imu.PigeonSwerve;
import swervelibnew.imu.PigeonViaTalonSRXSwerve;
import swervelibnew.imu.SwerveIMU;
import swervelibnew.motors.SparkFlexSwerve;
import swervelibnew.motors.SparkMaxBrushedMotorAttached;
import swervelibnew.motors.SparkMaxBrushedMotorAttached.T;
import swervelibnew.motors.SparkMaxBrushedMotorSwerve;
import swervelibnew.motors.SparkMaxBrushedMotorSwerve.Type;
import swervelibnew.motors.SparkMaxSwerve;
import swervelibnew.motors.SwerveMotor;
import swervelibnew.motors.TalonFXSSwerve;
import swervelibnew.motors.TalonFXSwerve;
import swervelibnew.motors.TalonSRXSwerve;
import swervelibnew.motors.ThriftyNovaSwerve;
...
public class DeviceJson
{
  ...
  public SwerveMotor createMotor(boolean isDriveMotor)
  {
    ...
    switch (type)
    {
      ...
      case "sparkmax_brushed_alternative":
        return new SparkMaxBrushedMotorAttached(id, isDriveMotor, T.kAnalogSensor, 5, DCMotor.getCIM(1));
      case "nova_neo":
