...
public class SwerveModulePhysicalCharacteristics
{
   ...
   * {@link swervelibnew.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)}.
   */
   ...
   *                                       {@link swervelibnew.math.SwerveMath#calculateMetersPerRotation(double, double,
   *                                       double)} and
   *                                       {@link swervelibnew.math.SwerveMath#calculateDegreesPerSteeringRotation(double,
   *                                       double)}.
