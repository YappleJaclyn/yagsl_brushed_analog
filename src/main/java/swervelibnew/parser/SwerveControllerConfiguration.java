...
import static swervelibnew.math.SwerveMath.calculateMaxAngularVelocity;

/**
 * Swerve Controller configuration class which is used to configure {@link swervelibnew.SwerveController}.
 */
