...
/**
 * Swerve Module configuration class which is used to configure {@link swervelibnew.SwerveModule}.
 */
public class SwerveModuleConfiguration
{
   ...
   * {@link swervelibnew.math.SwerveMath#calculateMetersPerRotation(double, double, double)} and
   * {@link swervelibnew.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} respectively to calculate the
   * conversion factors.
   */
