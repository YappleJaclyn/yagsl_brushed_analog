 ...
 */
public class SparkMaxBrushedMotorAttached extends SwerveMotor
{
   ...
   */
  public SparkMaxBrushedMotorAttached(SparkMax motor, boolean isDriveMotor, T encoderType, double voltage,
                                     DCMotor motorType)
  {
    ...
    if (encoderType == T.kHallSensor)
    {
      encoderType = T.kQuadrature;
    }
   ...
   */
  public SparkMaxBrushedMotorAttached(int id, boolean isDriveMotor, T encoderType, double voltage,
                                     DCMotor motorType)
  {
    this(new SparkMax(id, MotorType.kBrushed), isDriveMotor, encoderType, voltage,
        motorType);
  }
  ...
  public SwerveMotor setAbsoluteEncoder(SwerveAbsoluteEncoder encoder)
  {
      ...
      velocity = this.absoluteEncoder::getVelocity;
      position = this.absoluteEncoder::getAbsolutePosition;
    return this;
  }
