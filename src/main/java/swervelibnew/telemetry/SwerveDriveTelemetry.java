package swervelibnew.telemetry;
...
/**
 * Telemetry to describe the {@link swervelibnew.SwerveDrive} following frc-web-components. (Which follows AdvantageKit)
 */
public class SwerveDriveTelemetry
{
   ...
   * {@link swervelibnew.SwerveModule#setDesiredState(SwerveModuleState, boolean, double)} is called for the last module.
   */
