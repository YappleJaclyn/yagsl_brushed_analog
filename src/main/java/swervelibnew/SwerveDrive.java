...
import swervelibnew.simulation.SwerveIMUSimulation;
...
//    resetOdometry(newOdometry);
  ...
  /**
   * Enable or disable the {@link swervelibnew.parser.SwerveModuleConfiguration#useCosineCompensator} for all
