...
/**
 * Simulation for {@link swervelibnew.SwerveDrive} IMU.
 */
public class SwerveIMUSimulation
{
  ...
  /**
   * Update the odometry of the simulated {@link swervelibnew.SwerveDrive} and post the {@link swervelibnew.SwerveModule}
